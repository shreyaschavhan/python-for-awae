...
def client_handler(client_socket):
    ...
    if command:
        while True:
            # show a simpmle prompt
            client_socket.send("<BlackHatPython:#> ".encode('utf-8'))
...
def client_sender(buffer):
    ...
    try:
        ...
        # if we detect input form stdin send it
...
def main():
    ...
    # upload thigns, execute commands and drop a shell back
